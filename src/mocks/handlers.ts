      ...
      data: [
        {
          ...
          content:
            "요즘 의대 정원 확대 때문에 정부 vs. 의사가 맞서 의료 공백 문제로 시끌시끌하잖아요. 코로나19 같은 감염병 위기가 아닌데도 보건의료재난 경보 단계를 최상위인 ‘심각’ 상태인데요. 최근 정부가 전공의들이 병원에서 떠나며 생긴 의료 공백을 줄이기 위해 “비대면 진료, 확 허용해!” 해서 갑론을박이 벌어지고 있어요. 텍스트가 이렇게 길 경우 얼마나 말줄임을 해야할지?",
          voteItems: [
            {
              voteItemId: 1,
